...
def main():
    path = os.path.join(os.getcwd(), 'v4\\32-Users\\Users_time_aligned')
    trainp = os.path.join(os.getcwd(), 'v4\\32-Users\\RNN-Train-Aligned')
    testp = os.path.join(os.getcwd(), 'v4\\32-Users\\RNN-Test-Aligned')
